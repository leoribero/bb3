			...
			<!-- Main -->
				<div id="main">
					<div class="inner">
						...
						<!-- Header -->
							<header id="header">
								<a href="index.html" class="logo"><strong>637</strong> by HTML5 UP</a>
								<ul class="icons">
						...
						<!-- Banner -->
							<section id="banner">
								...
								<span class="image object">
									<img src="<?php bloginfo('template_url'); ?>/images/pic10.jpg" />
								</span>
							</section>
						...
						<!-- Section -->
							<section>
								...
								<div class="posts">
									<article>
										<a href="#" class="image"><img src="<?php bloginfo('template_url'); ?>/images/pic01.jpg" alt="" /></a>
									...
									<article>
										<a href="#" class="image"><img src="<?php bloginfo('template_url'); ?>/images/pic02.jpg" alt="" /></a>
